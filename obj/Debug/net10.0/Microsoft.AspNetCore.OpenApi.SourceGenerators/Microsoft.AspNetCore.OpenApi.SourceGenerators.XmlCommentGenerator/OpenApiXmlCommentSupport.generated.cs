...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"T:MyAPI.Migrations.InitialCreate", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.ReplaceProductsWithBusLines", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.CreateUsersTable", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.AddAuditFieldsToBusLinesAndUserFields", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.AddBusLineUserForeignKeys", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.AddRouteFieldsToBusLines", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.AddBuslineFields", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:MyAPI.Migrations.RepairChatMessages", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "CFPQwHDF8Cgo4t/vi/+7djICAABQcm9ncmFtLmNz")]
